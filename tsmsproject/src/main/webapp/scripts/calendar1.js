...
function WebCalendar() //初始化日历的设置
{
    ...
    this.yearFall   = 70;           //定义显示的年份下拉框的年差值，如果今年是2000年，这里设置为50，就显示1950－2050
...
function birthdaychange(elementId)//日期效验
{
	var birthday = document.getElementById(elementId).value;
	if(birthday==""){
		return;
	}
	...
	var first=birthday.indexOf("-");
	var last=birthday.lastIndexOf("-");
