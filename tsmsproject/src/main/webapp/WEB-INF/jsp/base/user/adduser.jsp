...
<body>
 <form id="userform" action="${baseurl}user/addUserSumit.action" method="post">
							...
							<tbody>
								<tr>
									...
									<td class=category width="35%">
										<div>
											<input type="text" id="sysuser_userid" name="userinfoCustom.userid"/>
									...
									<td class=category width="35%">
										<div>
											<input type="text" id="sysuser_username" name="userinfoCustom.username" />
										</div>
								...
								<tr>
									...
									<td class=category width="35%">
										<div>
											<input type="password" id="sysuser_password" name="userinfoCustom.userpass" />
										</div>
									...
									<td class=category width="35%">
										<div>
											<input type="text" id="sysuser_sex" name="userinfoCustom.usersex" />
										</div>
								...
								<tr>
									...
									<td class=category width="35%">
									     <input type="text" id="sysuser_cellphone" name="userinfoCustom.cellphone" />
									</td>
									<td height=30 width="15%" align=right>用户邮箱：</td>
									  <td class=category width="35%">
									      <input type="text" id="sysuser_useremail" name="userinfoCustom.useremail" />
									 </td>
								</tr>
								<tr>
									<td height=30 width="15%" align=right>是否厂家用户：</td>
									<td class=category width="35%">
									     <input type="text" id="sysuser_ismakeruser" name="userinfoCustom.ismakeruser" />
									</td>
								</tr>
								<tr>
									<td colspan=4 align=center class=category>
									  <a id="submitbtn" class="easyui-linkbutton" iconCls="icon-ok" href="#" onclick="sysusersave()">提交</a> 
									  <a id="closebtn" class="easyui-linkbutton" iconCls="icon-cancel" href="#"onclick="parent.closemodalwindow()">关闭</a></td>
								</tr>
						</tbody>
						</table> 
					</td>
