...
<script type="text/javascript">
	...
	var columns_v = [ [ {
		...
		field : 'usersex',//对应json中的key
		title : '性别',
		width : 120,
	},  {
		field : 'cellphone',//对应json中的key
		title : '手机',
		width : 120
	}, {
		field : 'useremail',//对应json中的key
		title : '用户邮箱',
		width : 120
	}, {
		field : 'opt1',
		...
		formatter : function(value, row, index) {
			...
			return "<a href=javascript:deleteuser('" +  row.userid  + "')>删除</a>";
		}
	}, {
		field : 'opt2',
		title : '修改',
		width : 180,
		formatter : function(value, row, index) {
			return "<a href=javascript:edituser('" + row.userid + "')>修改</a>";
		}
	} ] ];
	//定义 datagird工具
	var toolbar_v = [ {//工具栏
...
<body>
		...
		<table class="table_search">
			<tbody>
				<tr>
					...
					<td><INPUT type="text" name="userinfoCustom.username" /></td>
					<td><a id="btn" href="#" onclick="queryuser()" class="easyui-linkbutton" iconCls='icon-search'>查询</a></td>
				</tr>
			</tbody>
		</table>
		<!-- 查询列表 -->
		<tablle border=0 cellSpacing=0 cellPadding=0 width="100%" align=center>
			<tbody>
				<tr>
					<td>
	...
	<form id="sysuserdeleteform" action="${baseurl}user/userDelete.action" method="post">
